        ...
        if(props.isExpand === 'true'){  //展开图标
            ...
            if(props.sort){
                str = `<div ${style?'style="'+style+'"':''} class='${cssArr.join(" ")}'>
                        ...
                        &nbsp;&nbsp;
                        <div class='nd-grid-sort'>
                            <b class='nd-grid-sort-raise' e-click='raiseSort'/>
                            <b class='nd-grid-sort-down' e-click='downSort'/>
                        </div>
                    </div>`;
            }else{
                str = `<div ${style?'style="'+style+'"':''} class='${cssArr.join(" ")}'>
